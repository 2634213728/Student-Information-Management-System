	...
	<div class="centercontent" align ="center">
		<div >
			...
			<form action="servlet/AdminServlet?action=addStudent" method="post">
				<p>
					<label>姓名</label>
					<span class="field"><input required="required" type="text" name="sname" class="mediuminput" /></span>
				</p>
				<br>
				<p>
					<label>密码</label>
					<span class="field"><input required="required" type="text" name="spwp" class="mediuminput" /></span>
				</p>
				<br>
				<p>
					<label>性别</label>
					<span class="field"><input required="required" type="text" name="ssex" class="mediuminput" /></span>
				</p>
				<br>
				<p>
					<label>生日</label>
					<span class="field"><input required="required" type="text" name="sbri" class="mediuminput" /></span>
				</p>
				<br>
