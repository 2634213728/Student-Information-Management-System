	...
	<div class="vernav2 iconmenu">
		<ul>
			...
			<li><a href="#addons" class="addons">其他页面</a>
				...
				<ul id="addons">
					<li><a href="https://news.baidu.com">新闻订阅</a></li>
					<li><a href="servlet/LoginServlet?action=logout">退出登录</a></li>
				</ul>
			</li>
		</ul>
	...
	<div class="centercontent">
		<table width="90%" class="table">
			...
			<tr bgcolor="<%=color[i%2] %>">
				...
				<td><a href="searchAll.jsp?sid=<%=student.getSid() %>&sname=<%=student.getSname() %>&ssex=<%=student.getSex() %>&sbri=<%=student.getBri() %>">报表生成</a></td>
				<td> <a href="servlet/AdminServlet?action=deletestudent&sid=<%=student.getSid()%>" onclick=" javascript:return confirmAct()">删除</a></td>
			</tr>
